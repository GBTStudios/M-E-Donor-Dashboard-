...
import { setRole, setFirstLoginFlag } from "@/lib/adminAuth";
...
export default function LoginForm() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    // Save role and first_login flag to localStorage so guards and
    // sidebar role checks work correctly on every page after login.
    setRole(result.user.role as "superadmin" | "admin" | "donor");
    setFirstLoginFlag(result.first_login);
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48">
      <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.9 32.5 29.4 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l6.1-6.1C34.6 5.9 29.6 4 24 4 12.94 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.2-.1-2.4-.4-3.5z"/>
